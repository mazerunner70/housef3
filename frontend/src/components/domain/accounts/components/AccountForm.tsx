...
import { AccountCreate, AccountType, Currency } from '@/schemas/Account';
...
const getEnumKeys = (e: Record<string, string>) => Object.keys(e).filter(k => typeof e[k] === 'string'); // Filter by string values to get keys
...
const AccountForm: React.FC<AccountFormProps> = ({ initialData, onSubmit, onCancel, formTitle }) => {
    const [formData, setFormData] = useState<AccountCreate>({
        ...
        ...(initialData || {} as Partial<AccountCreate>),
    });
